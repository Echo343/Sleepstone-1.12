...
import com.blargsworkshop.sleepstone.potion.potions.HorseSpiritPotion;
...
public class ModItems implements IModItems{
	...
	public static class Potions {
		...
		public static BlargsPotion horseSpirit = new HorseSpiritPotion(new ResourceLocation(ModInfo.ID, "horsespirit"), "potion.horsespirit");
	}
