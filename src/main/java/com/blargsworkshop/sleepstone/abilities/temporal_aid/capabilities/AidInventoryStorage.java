...
public class AidInventoryStorage implements IStorage<IAidInventory> {

    @Override
    public NBTBase writeNBT(Capability<IAidInventory> capability, IAidInventory instance, EnumFacing side)
    {
    ...
    @Override
    public void readNBT(Capability<IAidInventory> capability, IAidInventory instance, EnumFacing side, NBTBase base)
    {
